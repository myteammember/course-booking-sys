  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="teacher.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  ...
                  <?php while($row= mysqli_fetch_array($result)) { ?>
                    <tr>
                      ...
                      <ul class="dropdown-menu  dropdown-menu-end  px-0 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton" style="width: 5rem;">
                        ...
                        <li class="mb-2">
                          <a class="dropdown-item border-radius-md text-center" href='edit_teacher.php'>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    ...
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Course</th>
                      <th></th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm"><?=$rows['student_name'] ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0"><?=$rows['student_gender'] ?></p>
                      </td>
                      <td> 
                        <span class="text-xs font-weight-bold"><?=$rows['class_id'] ?></span>
                      </td>
                      <td class="align-middle text-center">
                        <div class="d-flex align-items-center justify-content-center">
                          <span class="me-2 text-xs font-weight-bold"><?=$rows['s_course'] ?></span>
                        </div>
                      </td>
                      <td class="align-middle">
                      <a href="javascript:;" class="nav-link text-body p-0" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                      ...
                      <ul class="dropdown-menu  dropdown-menu-end  px-0 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton" style="width: 5rem;">
                        <li class="mb-2 ">
                          <a class="dropdown-item border-radius-md text-center" href="delete_student.php?id=<?=$row['student_id']?>" onclick="return confirm('Are you sure want to delete staff <?=$row["student_name"]?>?');">
                          <i class="fa fa-trash text-xs"></i>  
                          </a>
                        </li>
                        <li class="mb-2">
                          <a class="dropdown-item border-radius-md text-center" href='edit_student.php'>
                          <i class="fa fa-pen text-xs"></i>
                          </a>
                        </li>
