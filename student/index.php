<?php
  ...
  if(isset($_POST['login'])){
    if(!empty($_POST['email']) && !empty($_POST['pwd'])){
      $email=$_POST['email'];
      $pwd=$_POST['pwd'];
      $qry ="SELECT * FROM student WHERE s_email='".$email."' AND student_pass='".$pwd."'";
              ...
              <div class="card-body">
                <form role="form" class="text-start" action="index.php" method="post">
                  ...
                  <div class="text-center">
                    <input type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2" name="login" value="Sign In">
                  </div> 
                </form>
              </div>
            </div>
