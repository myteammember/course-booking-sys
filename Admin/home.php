      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-success text-sm font-weight-bolder"> 0% </span>than lask month</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">New Student</p>
                <h4 class="mb-0">0</h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
        ...
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
          <div class="card z-index-2  ">
            ...
            <div class="card-body">
              ...
              <p class="text-sm "> (<span class="font-weight-bolder">+0%</span>) increase in today sales. </p>
              <hr class="dark horizontal">
              <div class="d-flex ">
                <i class="material-icons text-sm my-auto me-1">schedule</i>
              ...
              <div class="row">
                <div class="col-lg-6 col-7">
                  ...
                  <p class="text-sm mb-0">
                    ...
                    <span class="font-weight-bold ms-1">0 done</span> this month
                  </p>
                </div>
