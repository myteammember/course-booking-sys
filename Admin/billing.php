                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">PAID</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Edit</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Print Reseip</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="javascript:;" class="text-center text-secondary font-weight-bold text-xs ps-3" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                        </a>
